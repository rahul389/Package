        ...
        // Defaults
            ...
            rolesData: function () {
                ...
                $('#roles-table').DataTable({
                    ...
                    language: {
                        sSearch: "Search ",
                        searchPlaceholder: 'Search {{ trans("role::views.role")}}',
                    },
                    order:['3','desc'],
            ...
            deleteRole: function (id) {
                $(document).on('click', '.delete-role', function (e) {
                    ...
                    var message = '';
                    swalInit({
                        title: "{{trans('role::messages.are_you_sure')}}",
                        text: "{{trans('role::messages.you_are_going_to_action_this_attribute', ['action' => 'delete', 'attribute' => 'role'])}}",
                        type: 'warning',
                        showCancelButton: true,
                        confirmButtonClass: 'btn btn-danger',
                        confirmButtonText: '{{trans('role::views.delete')}}',
                        ...
                        preConfirm: function () {
                            $.ajax({
                                ...
                                statusCode: {
                                    204: function (data) {
                                        app.rolesData();
                                        message = '{{trans('role::messages.attribute_action_successfully',['attribute' => trans('role::views.role'), 'action' => 'deleted'])}}';
            ...
            toggleRoleStatus: function () {
                $(document).on('click', '.toggle-role-status', function (e) {
                    ...
                    var message = $(this).hasClass('inactive') ? '{{ trans("role::messages.attribute_action_successfully", ["attribute" => "Role", "action" => "activated"])}}' : '{{ trans("role::messages.attribute_action_successfully", ["attribute" => "Role", "action" => "deactivated"])}}';
                    var text = $(this).hasClass('active') ? '{{ trans('role::messages.you_are_going_to_action_this_attribute',['action' => 'deactivate', 'attribute' => 'role'])}}' : '{{ trans('role::messages.you_are_going_to_action_this_attribute',['action' => 'activate', 'attribute' => 'role'])}}';
                    var btnTxt = $(this).hasClass('active') ? '{{ trans('role::views.deactivate')}}' : '{{ trans('role::views.activate')}}';
