    ...
    <div class="content edit-new-wrapper">
        <div class="card card-margin">
            ...
            <div class="card-header header-elements-inline">
                <h5 class="card-title">{{ trans('role::views.edit_role') }}</h5>
                 <div class="header-elements">
                            <a href="{{route('roles.index')}}" class="btn btn-danger btn-custom-width">{{ trans('role::views.cancel') }}</a>
                            <button type="submit" class="btn btn-primary ml-2 btn-custom-width">{{ trans('role::views.update') }}</button>
             </div>
            </div>
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ trans('role::views.role_name') }}" class="form-control"
